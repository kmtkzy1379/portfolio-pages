  ...
  works: [
    {
      ...
      blocks: [
        ...
        { type: 'p', text: 'ハルシネーション対策として、RAG（資料を根拠に答えさせる技術）で回答の質を担保しました。採用したのは<strong>依存ライブラリゼロの自作BM25検索（文字2-gram）</strong>で、数十件規模を1ms未満で引けます。Ruri v3 や text-embedding-3-small は<strong>オーバースペックで採用しませんでした。</strong>' },
        { type: 'h3', text: '自由度の追求' },
